...
"<br />views "+d.statistic.pageview+" / forked "+d.statistic.forked+" / &hearts; "+d.statistic.favorite+"</p></div></div></div>"}}a.current=a.maxCodes=c;a.timer=false;a.timeout=a.interval;if(a.loop!==true)a.interval=a.duration=0;c&&i()}})}})})();return h}})(jQuery);